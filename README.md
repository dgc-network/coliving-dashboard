...
If you want to have contracts running locally, you'll also need to run this [setup script](https://github.com/ColivingProject/coliving-protocol/blob/main/service-commands/scripts/setup.js) e.g. `node setup.js run eth-contracts up`
